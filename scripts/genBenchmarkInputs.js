...
for (let i = 0; i < numCases; i++) {
  ...
  caseInputs.push({
    x: BN.random(36).times(negX).toFixed(36),
    y: BN.random(36).times(negY).toFixed(36),
  })
  caseInputs.push({
    x: BN.random(36).times(negX).toFixed(36),
    y: BN.random(18).times(MAX_U256).div("1000000000000000000").times(negY).toFixed(18),
  })
  caseInputs.push({
    x: BN.random(18).times(MAX_U256).div("1e18").times(negX).toFixed(18),
    y: BN.random(18).times(MAX_U256).div("1e18").times(negY).toFixed(18),
  })
}
